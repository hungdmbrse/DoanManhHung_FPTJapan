...
public class DBUtils {
    ...
    public static Book findBookByComID(Connection conn, String id) throws SQLException {
    ...
    public static void insertBook(Connection conn, Book book) throws SQLException {
    	...
    	String sql1 = "select max(a.id) from `book` a";
    ...
    public static void insertComment(Connection conn, Comment commt) throws SQLException {
    	String sql1 = "select max(a.id) from `comment` a";
    ...
    public static void deleteBook(Connection conn, String code) throws SQLException {
    	...
    	deleteCommentByBookID(conn, code);
    ...
    public static void deleteCommentByBookID(Connection conn, String bookid) throws SQLException {
		String sql = "Delete From `comment` where book_id= ?";
